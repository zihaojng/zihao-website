          ...
          <div className="flex-1 space-y-8">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-lg text-slate-600">
                ...
                <p className="text-gray-950 text-base">Previously led product at a crypto company that raised $1B. Also PM for Assassin's Creed <img src="/lovable-uploads/5e5b86f8-e89c-4575-b42b-35b0f215ec0e.png" alt="Assassin's Creed Icon" className="inline-block h-6 w-6 -mt-1" /></p>
